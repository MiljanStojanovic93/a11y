import { useSSRContext, version, defineComponent, withAsyncContext, ref, resolveComponent, unref, withCtx, createTextVNode, toDisplayString, isRef, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, mergeProps, resolveDynamicComponent, withDirectives, vShow, computed, watchEffect, watch, getCurrentInstance, inject } from 'vue';
import { f as getRequestURL } from '../../index.mjs';
import { a as useSupabaseClient, e as useRoute, u as useSupabaseUser, g as createError, c as useToast, k as useRequestEvent, l as joinURL, m as useRuntimeConfig } from '../server.mjs';
import { a as useClipboard } from './index-8b092d42.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderVNode, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
import { _ as __nuxt_component_0 } from './nuxt-link-295e6065.mjs';
import __nuxt_component_0$1 from './logo-3c5aec70.mjs';
import __nuxt_component_0$2 from './worried-face-6120ec54.mjs';
import __nuxt_component_1 from './confused-face-0428d40a.mjs';
import __nuxt_component_2 from './smiling-face-e7198ef2.mjs';
import __nuxt_component_3 from './without-mouth-face-23a352dd.mjs';
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SvgoWorriedFace = __nuxt_component_0$2;
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                if (tTKey in unref(collapsibleItemsState)) {
                  ...
                  _push2(`<span class="inline-block font-bold"${_scopeId}>${ssrInterpolate(tTKey)}:\xA0 </span>`);
                }
...
//# sourceMappingURL=_id_-69f1d5f2.mjs.map
