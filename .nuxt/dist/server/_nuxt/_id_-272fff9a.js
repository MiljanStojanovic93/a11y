...
import { _ as __nuxt_component_0$1, a as useSupabaseClient, f as useRoute, g as useRouter, c as createError } from "../server.mjs";
import { _ as __nuxt_component_0$2 } from "./Spinner-e14ec5b8.js";
import { ref, computed, defineComponent, withAsyncContext, resolveComponent, unref, withCtx, createTextVNode, toDisplayString, isRef, createVNode, openBlock, createBlock, createCommentVNode, defineAsyncComponent, useSSRContext, watch, mergeProps, Fragment, renderList } from "vue";
import { g as getStatus, u as useAudit } from "./get-status-8e496c81.js";
import { r as refDebounced, u as useIntersectionObserver } from "./index-8b092d42.js";
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import "hookable";
import "destr";
import "devalue";
import "klona";
import { a as availableScreenSizes } from "./screenSizes-4ba45971.js";
import "ufo";
import "ofetch";
...
const __nuxt_component_3_lazy = /* @__PURE__ */ defineAsyncComponent(() => import("./AuditSelectReportTypeModalContent-10e7c1d0.js").then((m) => m.default || m));
  ...
  async setup(__props) {
    ...
    const urlAndSelectorOptions = axeResults == null ? void 0 : axeResults.map((result) => {
      ...
      const screenSize2 = availableScreenSizes.find(
        (availableScreenSize) => {
          var _a3;
          return availableScreenSize.viewport.toString() === ((_a3 = result.size) == null ? void 0 : _a3.toString());
        }
      );
      return {
        id: result.id,
        name: `${(_a2 = result.results) == null ? void 0 : _a2.url} - ${result.selector ?? ""}`,
                  ...
                  if (_push3) {
                    ...
                    if ((_g = (_f = (_e = unref(auditInfo).config) == null ? void 0 : _e.basicAuth) == null ? void 0 : _f.username) == null ? void 0 : _g.length) {
                      ...
                      ssrRenderList(unref(auditInfo).config.basicAuth, (tTValue, tTKey) => {
                        _push3(`<li${_scopeId2}><span class="font-bold first-letter:uppercase"${_scopeId2}>${ssrInterpolate(tTKey)}: </span>   ${ssrInterpolate(tTValue)}</li>`);
                      });
                      _push3(`<!--]--></ul></li>`);
                    } else {
                      _push3(`<!---->`);
                          ...
                          createVNode("ul", { class: "list-disc pl-8" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(unref(auditInfo).config.basicAuth, (tTValue, tTKey) => {
                              return openBlock(), createBlock("li", { key: tTKey }, [
                                ...
                                createTextVNode("   " + toDisplayString(tTValue), 1)
                              ]);
                            }), 128))
                          ])
                        ])) : createCommentVNode("", true),
...
//# sourceMappingURL=_id_-272fff9a.js.map
