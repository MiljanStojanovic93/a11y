globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getCookie, createError, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/h3/dist/index.mjs';
import { chromium } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/.pnpm/playwright@1.43.1/node_modules/playwright/index.mjs';
import AxeBuilder from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/.pnpm/@axe-core+playwright@4.9.0_playwright-core@1.43.1/node_modules/@axe-core/playwright/dist/index.mjs';
import { createClient } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/@supabase/supabase-js/dist/main/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/miljan/Projects/a11y-audit-tool-master/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/miljan/Projects/a11y-audit-tool-master/server/assets"}];
...
storage.mount('db', unstorage_47drivers_47fs({"driver":"fs","base":"/home/miljan/Projects/a11y-audit-tool-master/audits/db","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/miljan/Projects/a11y-audit-tool-master","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/miljan/Projects/a11y-audit-tool-master/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/miljan/Projects/a11y-audit-tool-master/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/miljan/Projects/a11y-audit-tool-master/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/miljan/Projects/a11y-audit-tool-master/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_9MKNxw = () => Promise.resolve().then(function () { return test_post$1; });
const _lazy_008yE9 = () => Promise.resolve().then(function () { return users_get$1; });
const _lazy_kp9Evd = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/test', handler: _lazy_9MKNxw, lazy: true, middleware: false, method: "post" },
  { route: '/api/users', handler: _lazy_008yE9, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_kp9Evd, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_kp9Evd, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":""}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"titleTemplate":"%s | A11y audits"};
...
const getClientManifest = () => import('file:///home/miljan/Projects/a11y-audit-tool-master/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/miljan/Projects/a11y-audit-tool-master/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
